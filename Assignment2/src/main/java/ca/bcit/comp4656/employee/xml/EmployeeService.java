 ...
 * 
 */
@WebServiceClient(name = "EmployeeService", targetNamespace = "http://www.bcit.ca/comp4656/employee/xml", wsdlLocation = "file:/C:/Users/Yasha/Desktop/COMP%204656/Assignment2/Assignment2/Assignment2/src/main/resources/employee.wsdl")
    ...
    extends Service
{
    ...
    private final static QName EMPLOYEESERVICE_QNAME = new QName("http://www.bcit.ca/comp4656/employee/xml", "EmployeeService");

    static {
        URL url = null;
        WebServiceException e = null;
        try {
            url = new URL("file:/C:/Users/Yasha/Desktop/COMP%204656/Assignment2/Assignment2/Assignment2/src/main/resources/employee.wsdl");
    ...
    public EmployeeServicePort getEmployeeServicePort() {
        return super.getPort(new QName("http://www.bcit.ca/comp4656/employee/xml", "EmployeeServicePort"), EmployeeServicePort.class);
    }
    ...
    public EmployeeServicePort getEmployeeServicePort(WebServiceFeature... features) {
        return super.getPort(new QName("http://www.bcit.ca/comp4656/employee/xml", "EmployeeServicePort"), EmployeeServicePort.class, features);
    }
